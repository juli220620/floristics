...
public class GameSystemService {
     ...
     */
    public Map<String, Long> addSystem(UserEntity user, String systemId) {
     ...
     * @return Map of upgrade costs by currency to subtract from user funds
     */
    public Map<String, Long> upgradeSystem(UserEntity user, String systemId) {
        ...
        Map<String, Long> costs = Optional.ofNullable(target.getCost().get(userSystem.getSystemLevel() + 1))
